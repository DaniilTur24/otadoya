...
export const MONTHLY_REPORT_ROWS: MonthlyReportRow[] = [
  ...
  { key: 'wholesaleRevenue', label: 'ВЫРУЧКА опт', source: 'calc', bold: true, rowType: 'income' },
  ...
  { key: 'fixedAssets', label: 'Расходы по обслуг.ФА', source: 'empty', rowType: 'expense' },
  { key: 'standardKaspibot', label: 'Стандарт Ни Каспибот', source: 'empty', rowType: 'expense' },
